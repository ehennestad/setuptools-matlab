...
%       responsibility of this function or upstream?
    ...
    [isInstalled, version] = setuptools.internal.fex.isToolboxInstalled(toolboxIdentifier, options.Version);
    ...
    if isInstalled
        ...
        if endsWith(addonUrl, '/zip')
            [tempFilepath, C] = setuptools.internal.utility.tempsave(addonUrl, [toolboxIdentifier, '_temp.zip']);
        ...
        elseif endsWith(addonUrl, '/mltbx')
            [tempFilepath, C] = setuptools.internal.utility.tempsave(addonUrl, [toolboxIdentifier, '_temp.mltbx']);
